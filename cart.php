...
foreach ($panierClient as $key => $value) {
  ...
  echo '<td class="text-center"><form method="post" action="updatecart.php"><input type="hidden" name="produit" value="'.$panierClient[$key]['idProduit'].'"><input type="number" name="quantite" value="'.$panierClient[$key]['qteProduit'].'"><input type="submit" name="btnSub" value="Modifier" class="btn btn-xs btn-primary"></form></td>';
